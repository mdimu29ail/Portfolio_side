...
import { ArrowRight, Database, Cpu, Zap, Terminal, Activity } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-[calc(100vh-80px)]">
          ...
          <div className="flex flex-col items-start text-left justify-center h-full">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter text-white leading-[0.95] md:leading-[0.9] mb-6 md:mb-8 font-sans">
              ...
              <RevealText delay={0.2} className="text-[#d9ff00]">Limits.</RevealText>
            </h1>
            ...
            >
              Architecting ultra-low latency ecosystems. We bridge the gap between complex backend infrastructure and fluid frontend experiences.
            </motion.p>
          ...
          >
              ...
              >
                  ...
                  <div className="h-10 border-b border-white/10 flex items-center px-4 justify-between bg-white/5">
                     ...
                     <span className="text-[10px] font-mono text-white/30">DASHBOARD.EXE</span>
                  </div>
                  ...
                  <div className="p-6 relative h-full flex flex-col">
                     <div className="flex justify-between items-end mb-8">
                        <div>
                          <div className="text-[10px] text-[#d9ff00] font-mono mb-1">CURRENT_LOAD</div>
                          <div className="text-4xl font-bold text-white">84<span className="text-lg text-white/50">%</span></div>
                        </div>
                     ...
                     <div className="mt-8 rounded-lg overflow-hidden border border-white/10 h-40 relative group">
                        <img src="https://i.ibb.co.com/DfPcstkw/1711445414023.jpg" className="w-full h-full object-cover opacity-50 grayscale group-hover:scale-110 transition-transform duration-700" alt="Code" />
              ...
              <motion.div variants={cardVariants} className="absolute top-20 -right-4 xl:right-0 bg-black/80 border border-white/10 p-5 rounded-xl shadow-2xl backdrop-blur-md w-48 z-20">
                  ...
                  <div className="text-xs text-white/40 uppercase tracking-wider">Latency</div>
              </motion.div>

              {/* Floating Widget 2: CPU */}
              <motion.div variants={cardVariants} className="absolute bottom-32 -left-4 xl:-left-10 bg-black/80 border border-white/10 p-5 rounded-xl shadow-2xl backdrop-blur-md w-44 z-20">
                  <div className="flex items-start justify-between mb-2">
                      <Cpu className="text-[#d9ff00]" size={20} />
                  </div>
                  <div className="text-2xl font-bold text-white mb-1">Neural</div>
                  <div className="text-xs text-white/40 uppercase tracking-wider">Engine v9</div>
              </motion.div>
          ...
          <div className="lg:hidden w-full h-64 sm:h-80 relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl mt-8">
               ...
               <img src="https://i.ibb.co.com/DfPcstkw/1711445414023.jpg" className="w-full h-full object-cover opacity-60 grayscale" alt="Mobile Visual" />
               <div className="absolute bottom-4 left-4 z-20">
                  <div className="flex items-center gap-2 text-[#d9ff00]">
                    <Activity size={20} />
                    <span className="font-mono text-sm font-bold">SYSTEM_READY</span>
                  </div>
               </div>
          </div>
        </div>
